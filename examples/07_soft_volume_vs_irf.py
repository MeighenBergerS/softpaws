...
the exact soft-volume path models that attenuation, so the soft-volume
prediction (and hence the implied efficiency) is likely overestimated here,
more so at the high-energy end of the fit range. Treat the resulting
efficiency as indicative, not a reproduction of the paper's Section 4.1 fit,
which does model attenuation.
